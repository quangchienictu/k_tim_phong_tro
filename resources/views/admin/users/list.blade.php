...
<div class="content-wrapper">
	...
	<div class="content">
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="admin/users/pheduyet/{{$tk->id}}"><i class="icon-file-pdf"></i> Phê Duyệt</a></li>
		...
		<div class="footer text-muted">
			&copy; 2019. <a href="#">Project Phòng trọ Hà Nội</a> by <a href="" target="_blank">Ngọc Lan</a>
		</div>
		<!-- /footer -->
	</div>
</div>
